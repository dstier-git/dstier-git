...
- **Orca**, an agentic IDE that lets you group agent CLI sessions into tasks and projects for quick management. Includes smooth multi-pane terminal, a gorgeous UI, and very active maintainment. [Download](https://www.onorca.dev/)
